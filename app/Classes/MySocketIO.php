...
class MySocketIO
{
     ...
     * @var string
     */
    private $protocole = MySocketIO::NO_SECURE_PROTOCOLE;
    ...
    {
        if(!in_array($protocole, [MySocketIO::NO_SECURE_PROTOCOLE, MySocketIO::SSL_PROTOCOLE, MySocketIO::TLS_PROTOCOLE]))
        {
            $protocole = MySocketIO::NO_SECURE_PROTOCOLE;
        }

...
//                $watermarkSize = $img->width() / 2; //half of the image size
    ...
    private function makeResized($image_path, $i)
    {
        ...
        $this->app_resize_image_name = $this->rand . 'app_resize_image.jpg';
        ...
        $img1->save(public_path() . '/' . $this->store_path . '/' . $this->app_resize_image_name);
        $this->result['resize_path'][$i] = $this->store_path . '/' . $this->resize_image_name;
        $this->result['app_resize_path'][$i] = $this->store_path . '/' . $this->app_resize_image_name;
    }

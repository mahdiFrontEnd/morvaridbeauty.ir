                            ...
                            <div class="row align-items-center no-gutters">
                                ...
                                <div class="col-lg-2 col-md-12">
                                    <div class="d-single-info text-lg-center">
                                        <a href="https://demo.hasthemes.com/streamo-preview/streamo/cart.html" class="view-cart">view cart</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 col-lg-2">
                                ...
                                <ul role="tablist" class="nav flex-column dashboard-list">
                                    ...
                                    <li><a href="login-and-register.html" class="nav-link">logout</a></li>
                                </ul>
                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="https://demo.hasthemes.com/streamo-preview/streamo/cart.html" class="view">view</a></td>
                                                </tr>
                                                <tr>
                                                    <td>2</td>
                                                    <td>May 10, 2018</td>

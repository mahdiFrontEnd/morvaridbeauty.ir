                        ...
                        <ul class="solid-bullet-list">
                            <li>
                                ...
                                <div class="image-layers">
                                    ...
                                    <img class="img-sm rounded-circle image-layer-item" src="{{url('templates/melody/images/faces/face3.jpg.png')}}"
                                         alt="profile"/>
                                    <img class="img-sm rounded-circle image-layer-item" src="{{url('templates/melody/images/faces/face5.jpg')}}"
                                         alt="profile"/>
                                    <img class="img-sm rounded-circle image-layer-item" src="{{url('templates/melody/images/faces/face8.jpg')}}"
                                         alt="profile"/>
                                </div>
                            </li>
                            <li>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td class="py-1">
                                        <img src="{{url('templates/melody/images/faces/face13.jpg.png')}}" alt="profile"
                                ...
                                <tr>
                                    ...
                                    <td class="py-1">
                                        <img src="{{url('templates/melody/images/faces/face2.jpg.png')}}" alt="profile"
                                             class="img-sm rounded-circle"/>
                                    </td>
                                    <td class="font-weight-bold">
                                        نسترن افشار
                                ...
                                <tr>
                                    ...
                                    <td class="py-1">
                                        <img src="{{url('templates/melody/images/faces/face11.html')}}" alt="profile"
                                             class="img-sm rounded-circle"/>
                                    </td>
                                    <td class="font-weight-bold">
                                        رضا کریمی
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="add-items d-flex">
                            ...
                            <button class="add btn btn-primary font-weight-bold todo-list-add-btn" id="add-task">
                                افزودن
                            </button>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    <td class="py-1">
                                        <img src="{{url('templates/melody/images/faces/face1.jpg.png')}}" alt="profile"
                                             class="img-sm rounded-circle"/>
                                    </td>
                                    <td>
                                        پروژه 1
                                ...
                                <tr>
                                    <td class="py-1">
                                        <img src="{{url('templates/melody/images/faces/face3.jpg.png')}}" alt="profile"
                                             class="img-sm rounded-circle"/>
                                    </td>
                                    <td>
                                        پروژه 3
                                ...
                                <tr>
                                    <td class="py-1">
                                        <img src="{{url('templates/melody/images/faces/face4.jpg.png')}}" alt="profile"
                                             class="img-sm rounded-circle"/>
                                    </td>
                                    <td>
                                        پروژه 4

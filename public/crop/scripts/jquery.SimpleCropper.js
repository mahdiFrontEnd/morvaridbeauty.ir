...
(function ($) {
    ...
    $.fn.simpleCropper = function (upload_area,w,h,w1,h1,onComplete) {
        ...
        var aspX = 1;
        var aspY = 1;
        var file_display_area = this;
        var ias = null;
        var original_data = null;
        var jcrop_api;
        var bottom_html = "<input type='file' id='fileInput' name='files[]'/ accept='image/*'><canvas id='myCanvas' style='display:none;'></canvas><div id='modal'></div><div id='preview'><div class='buttons'><ul class='list-inline d-flex'><li class='cancel'></li><li class='ok'></li></ul></div></div>";
        $('#cropper').html(bottom_html);
        ...
        $(upload_area).on('drop', function (e) {
            ...
            aspY = h;
            // file_display_area = $(this);
            file_display_area = $('#form_image_preview');

            var file = e.originalEvent.dataTransfer.files;
            imageUpload($('#preview').get(0),file[0]);
        ...
        $(document).ready(function () {
            ...
            $('#fileInput').change(function (click) {
                ...
                imageUpload($('#preview').get(0),file);
                // Reset input value
                $(this).val("");
            });
        ...
        function preview() {
            ...
            file_display_area.html(imageFoo);
